...
### ADR-001: Four-Crate Architecture
**Decision**: Split into 4 crates: `tokenwise` (CLI), `tokenwise-core` (business logic), `adapter-claude`, `adapter-hermes`, `tokenwise-common`.
